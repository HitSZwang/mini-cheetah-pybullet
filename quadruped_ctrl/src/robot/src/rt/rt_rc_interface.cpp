...
//
// auto estop_switch = data.SWF; // 
// auto mode_selection_switch=data.SWE;
// auto QP_stand_switch =data.SWA;
...
//
//     case AT9S_BOOL_DOWN:
//        selected_mode = RC_mode::WAIT;
//
////         static int count(0);
////         count++;
////         if(count%1000 ==0)   printf("swf:AT9S_BOOL_DOWN!\n");
//
//         if(mode_selection_switch==AT9S_TRI_MIDDLE)
//             selected_mode = RC_mode::READY;
//         else if(mode_selection_switch==AT9S_TRI_DOWN)
//         {
//             selected_mode = RC_mode::STAND_UP;
//
//             if(Locomotion_switch==AT9S_BOOL_DOWN)
//             {
...
//                 rc_control.v_des[0] = v_scale * data.right_stick_x ;
//                 rc_control.v_des[1] = -v_scale * data.right_stick_y;
...
//
//             }
//             else if(QP_stand_switch==AT9S_BOOL_DOWN)
//             {
...
void sbus_packet_complete_at9s(){
    ...
    auto step_height=data.varB+1.0; // varB -1～1
    int selected_mode = 0;
//printf("at9s in\n");
    switch(estop_switch) {
        case AT9S_TRI_UP: // 
...
void sbus_packet_complete() {
  ...
  auto estop_switch = data.right_lower_right_switch; //  EStop,  recover run
  auto mode_selection_switch = data.left_lower_left_switch; //   backflip mpc 
